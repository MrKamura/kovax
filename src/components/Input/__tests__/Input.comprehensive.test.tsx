...
describe('Input', () => {
  describe('masks', () => {
    ...
    it('handles custom mask with letters and digits', () => {
      const handleChange = jest.fn();
      render(
        <Input 
          mask="AAA-999"
    ...
    it('handles basic letter and digit mask', () => {
      const handleChange = jest.fn();
      render(
        <Input 
          mask="aaa-999"
  ...
  describe('accessibility', () => {
    ...
    it('associates error message with input when provided', () => {
      render(
        <Input 
          isInvalid 
  ...
  describe('complex masks', () => {
    it('handles basic mixed characters with simple mask', () => {
      const handleChange = jest.fn();
      render(
        <Input 
          mask="99-aa"
