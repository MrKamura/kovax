...
import menuDoc from "../../../../docs/components/Menu.md?raw";
...
import avatar from "../../../../docs/components/Avatar.md?raw";
import badge from "../../../../docs/components/Badge.md?raw";
import skeleton from "../../../../docs/components/Skeleton.md?raw";
...
import paginationDoc from "../../../../docs/components/Pagination.md?raw";
...
export const menuDocumentationMarkdown = menuDoc;
...
export const avatarDocumentationMarkdown = avatar;
export const badgeDocumentationMarkdown = badge;
export const skeletonDocumentationMarkdown = skeleton;
...
export const paginationDocumentationMarkdown = paginationDoc;
