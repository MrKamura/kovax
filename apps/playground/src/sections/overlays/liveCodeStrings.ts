/** Strings for LiveExample "Code" tab — keep in sync with `OverlayLiveDemos.tsx` and `MenuLiveDemos.tsx`. */
...
export const MENU_BASIC_CODE = `import { Button, Menu, Text, themeToken } from "kovax-react";
  ...
  return (
    <Menu.Root>
      ...
      <Menu.Content placement="bottom-start">
        ...
        <Menu.Item onSelect={() => {}}>
          <Text size="sm" style={{ color: themeToken("error.600") }}>Delete</Text>
        </Menu.Item>
      </Menu.Content>
    </Menu.Root>
  );
...
export const MENU_CONTROLLED_CODE = `import { useState } from "react";
  ...
  return (
    <>
      <Menu.Root open={open} onOpenChange={setOpen}>
        ...
        <Menu.Content placement="bottom-start">
          <Menu.Item onSelect={() => setLast("Profile")}>
            <Text size="sm">Profile</Text>
          </Menu.Item>
          <Menu.Item onSelect={() => setLast("Billing")}>
...
export const MENU_SAME_WIDTH_CODE = `import { Button, Menu, Text } from "kovax-react";
...
export const MENU_NO_MOTION_CODE = `import { Button, Menu, Text } from "kovax-react";
